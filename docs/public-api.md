...
| Providers/frameworks | `wrap_openai`, `wrap_anthropic`, `wrap_mcp`, `wrap_langchain`, `patch_openai`, `patch_anthropic`, `automatic_openai_from_env`, `AgentCassetteRunHooks`, `patch_openai_agents`, `langchain_callback_handler` |
